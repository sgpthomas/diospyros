...
:PROPERTIES:
:header-args: :dir (magit-toplevel) :results output list :var SERVER="18.217.40.81"
:END:
...
- Copy the IP address into the properties drawer above
...
** Ablation
:PROPERTIES:
:header-args: :dir "/ssh:ubuntu@18.217.40.81:~/diospyros" :results output list
:END:
...
**** Links to JSON files
#+NAME: filelink
#+begin_src elisp :var files="" :results value
(require 'dash)
(--map (format "[[file:%s][%s]]\n"
	       (car it)
...
#+RESULTS: rules-files
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-100-rules.json |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-10-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-15-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-1-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-20-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-25-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-2-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-30-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-35-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-3-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-40-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-45-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-4-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-50-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-55-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-5-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-60-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-65-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-6-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-70-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-75-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-7-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-80-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-85-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-8-rules.json   |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-90-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-95-rules.json  |
| /home/samthomas/Research/diospyros/rulesets/var4-no-iso/n-9-rules.json   |
